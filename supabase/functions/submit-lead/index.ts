...
Deno.serve(async (req: Request) => {
  ...
  // `null`, arrays and scalars are valid JSON but not a lead.
  ...
  // Own keys only: a plain-object lookup also answers "constructor" and
  // "toString" with an inherited function, which would pass this check and be
  // written into the lead's notes as native-code source text.
