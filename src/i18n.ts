  ...
  es: {
    translation: {
      ...
      levelTest: {
        ...
        scale_score_disclaimer: "Estimación orientativa de Tyneside English Academy a partir de tus respuestas. No es una puntuación oficial emitida por Cambridge English.",
        recommended_course: "Curso Recomendado para Ti:",
        download_cert: "Descargar Certificado (PDF)",
  ...
  en: {
    translation: {
      ...
      levelTest: {
        ...
        scale_score: "Cambridge Scale Score",
        scale_score_disclaimer: "Tyneside English Academy's own estimate based on your answers. Not an official score issued by Cambridge English.",
